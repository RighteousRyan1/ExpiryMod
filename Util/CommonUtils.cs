...
namespace ExpiryMode.Util
{
    ...
    /// <summary>
    /// Mainly used for helping with Math, System doesn't have everything, ya know
    /// </summary>
    public class SimpleMath
    {
        ...
        /// </summary>
        /// <param name="x"> The number to Cube Root</param>
        /// <returns> Cube Root of said double</returns>
        public static double Cbrt(double x)
        {
            return Math.Pow(x, 1 / 3);
        }
        /// <summary>
        /// Ceilings (Rounds Up) the number returned by the Cube Root of X specified
        /// </summary>
        /// <param name="x"> The number to Cube Root</param>
        /// <returns> a double</returns>
        public static double CbrtCeil(double x)
        {
            return Math.Ceiling(Math.Pow(x, 1 / 3));
        }
        /// <summary>
        /// Floors (Rounds down) the number returned by the Cube Root of X specified
        /// </summary>
        /// <param name="x"> The number to Cube Root</param>
        /// <returns> a double </returns>
        public static double CbrtFloor(double x)
        {
        ...
        /// </summary>
        /// <param name="x"> Minimum given value </param>
        /// <param name="y"> Maximum given value </param>
        /// <returns> An integer between X and Y specified</returns>
        public static int FindCloseRand(int x, int y)
        {
            return x + Main.rand.Next(x - y, x + y);
        }
		/// <summary>
		/// Returns the ratio of NPCs to Players (NPCCount / PlayerCount)
		/// </summary>
		/// <returns> The ration of Players to NPCs</returns>
        public static float NPCToPlayerCountRatio()
        {
            float PlayerCount = 0;
            float NPCCount = 0;
